...
func (s *search) Attrs(attrs ...interface{}) *search {
	s.initAttrs = append(s.initAttrs, utils.ToSearchableMap(attrs...))
	return s
}

func (s *search) Assign(attrs ...interface{}) *search {
	s.assignAttrs = append(s.assignAttrs, utils.ToSearchableMap(attrs...))
	return s
}
...
func (s *search) Having(query interface{}, values ...interface{}) *search {
	if val, ok := query.(*utils.Expression); ok {
...
func (s *search) PreloadSearch(schema string, values ...interface{}) *search {
